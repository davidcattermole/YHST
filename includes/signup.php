<div class="modal hide" id="signUp" tabindex="-1" role="dialog" aria-labelledby="signUpForm">
  ...
  <form id="reg" name="reg" enctype="application/x-www-form-urlencoded" action="http://api.<?php echo $siteUrl ?>/v-2/client-register" method="post" class="form-horizontal">
      ...
      <div class="modal-body">
        ...
        <div class="api_input control-group" id="api_email">
        ...
        <div class="api_input control-group" id="api_first_name">
        ...
        <div class="api_input control-group" id="api_last_name">
        ...
        <div class="api_input control-group" id="api_country">
        ...
        <div class="api_input control-group" id="api_password">
        ...
        <div class="api_input control-group" id="api_password_confirm">
        ...
        <div class="api_input control-group" id="api_captcha">
          <label class="control-label" for="captcha">Type the characters you see on the right</label>
          <div class="controls">
            <img alt="captcha" src="http://api.main-hosting.com/captcha?transparent=1"/><br><br>
            <input type="text" name="captcha" id="captcha" value="" captcha_src="http://api.main-hosting.com/captcha?transparent=1">
          </div>  
        </div>
